...
end = pygame.font.SysFont(None,50)
ov = False
while not game_over:
    ...
    if snakeP[1] in range(5,600) and snakeP[0] == 795:
        ov = True
        pygame.quit()

    if snakeP[0] in range(5,800) and snakeP[1] == 595:
        ov = True
        pygame.quit()

    if snakeP[1] in range(5,600) and snakeP[0] == 5:
        ov = True
        pygame.quit()

    if snakeP[0] in range(5,800) and snakeP[1] == 5:
        ov = True
        pygame.quit()
    ...
    if snakeP[0] in range(W1x,W1x + 10) and snakeP[1] in range(W1y, W1y + W1L) or snakeP[0] in range(W2x,W2x+10) and snakeP[1] in range(W2y,W2y+W2L) or snakeP[0] in range(W3x,W3x+10) and snakeP[1] in range(W3y,W3y+W3L) or snakeP[0] in range(W11x,W11x+W11L) and snakeP[1] in range(W11y,W11y+10):
        ov = True
        pygame.quit()
    ...
    #if ov is True:
        #L = end.render('GAME OVER', True, wall_color1)
        #screen.blit(L, (400, 300))
        #pygame.time.delay(5)
        #time.sleep(5)
        #print("Game over")
        #pygame.quit()
